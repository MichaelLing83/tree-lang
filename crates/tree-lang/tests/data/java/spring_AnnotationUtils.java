 ...
 *
 * As a general rule for runtime-retained application annotations (for example, for
 ...
 * @see #isCandidateClass(Class, String)
 */
 public static boolean isCandidateClass(Class clazz, @Nullable Class annotationType) {
 ...
 */
 ...
 public static @Nullable A getAnnotation(Annotation annotation, Class annotationType) {
 ...
 * @since 3.1
 */
 public static @Nullable A getAnnotation(AnnotatedElement annotatedElement, Class annotationType) {
 // Shortcut: directly present on the element, with no merging needed?
 ...
 */
 public static @Nullable A getAnnotation(Method method, Class annotationType) {
 ...
 * This method mimics the functionality of
 ...
 * such annotations are either present, indirectly present,
 * or meta-present on the element.
 * This method mimics the functionality
 * {@link java.lang.reflect.AnnotatedElement#getAnnotationsByType(Class)}
 ...
 * @since 4.2
 */
 public static @Nullable A findAnnotation(
 ...
 */
 public static @Nullable A findAnnotation(Method method, @Nullable Class annotationType) {
 if (annotationType == null) {
 return null;
 }
 ...
 * @return the first matching annotation, or {@code null} if not found
 */
 public static @Nullable A findAnnotation(Class clazz, @Nullable Class annotationType) {
 if (annotationType == null) {
 return null;
 }
 ...
 * @see #getDefaultValue(Class, String)
 */
 public static @Nullable Object getDefaultValue(Class annotationType) {
